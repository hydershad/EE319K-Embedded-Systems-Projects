...
void ADC_Init(void){ 
  ...
  GPIO_PORTE_DEN_R &= ~0x10;		//DISABLE DIGITAL
	...
	ADC0_SSMUX3_R = ((ADC0_SSMUX3_R & 0xFFFFFFF0) + 1); //CLEAR SS3 FIELD AND SET CHANNEL TO 1(PE4)
...
return digital; 												//RETURN DIGITAL VALUE OF ANALOG VOLTAGE (0-3.3V ----> 0 TO 4095)
}
